...
numHidden     = 200;     % Change this, number of hidden neurons 
numIterations = 6000;   % Change this, number of iterations (epochs)
learningRate  = 0.2; %` Change this, your learning rate

pd = makedist("Uniform", -1,1);
[~, a] = size(XTrain);
W0 = random(pd,a,numHidden); % Change this, initialize your weight matrix W
V0 = random(pd,numHidden+1,length(unique(L)));
